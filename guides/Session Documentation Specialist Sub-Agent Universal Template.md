...
7\. \*\*Save\*\* to \`guides-and-instructions/chats/Session\_XX\_Title.md\`
...
\- \[ \] \`INSTALLATION\_GUIDE.md\` \- Installation steps  
...
\- \[MDN Web Docs \- CSS Grid\](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS\_Grid\_Layout) \- Implemented Y  
...
\*\*After completing this session, update:\*\* \`guides-and-instructions/chats/SESSION\_INDEX.md\`
...
\*\*Examples:\*\*  
\- \`Session\_23\_Mobile\_Navigation\_Directory\_Cleanup.md\`  
\- \`Session\_24\_Subtitle\_Burning\_Feature.md\`  
\- \`Session\_25\_Bug\_Fix\_Version\_Mismatch.md\`  
\- \`Session\_26\_Performance\_Optimization.md\`
...
ls guides-and-instructions/chats/ | grep \-E "Session\_\[0-9\]+" | sed 's/Session\_\\(\[0-9\]\*\\).\*/\\1/' | sort \-n | tail \-1  
\`\`\`
...
\*\*Good Titles:\*\*  
\- \`Mobile\_Navigation\_Hamburger\_Menu\` ✅  
\- \`Landing\_Page\_SEO\_Optimization\` ✅  
\- \`Subtitle\_Burning\_Implementation\` ✅
...
\*\*Location:\*\* \`guides-and-instructions/chats/SESSION\_INDEX.md\`
...
\*\*Next Session:\*\* Session\_24\_\[TBD\]  
\`\`\`
...
1\. Check directory for highest number:  
   \`\`\`bash  
   ls guides-and-instructions/chats/ | grep Session\_ | sort \-V | tail \-1  
   \`\`\`  
...
\#\#\# Integration  
\- \[ \] \*\*Session Index\*\* updated with new entry (\`SESSION\_INDEX.md\`)  
